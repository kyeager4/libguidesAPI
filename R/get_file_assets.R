...
#'
#' @description
#' This function calls the LibGuides GET assets API using a filter for document/file assets, and returns a dataframe of the matching assets.
...
#' @export
#' @examples
#' mydata <- get_file_assets(siteID="YOUR_SITEID_HERE", key="YOUR_KEY_HERE")
get_file_assets <- function(siteID=NULL, key=NULL, options=""){
  options <- paste0("&asset_types=4", options)
